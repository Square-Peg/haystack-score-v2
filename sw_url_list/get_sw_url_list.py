...
HS_OUTPUT_PATH = HS_SCORE_V2_DIR + "_sw_pull_list/hs_sw_pull_{}.csv".format(CURRENT_TS)
GP_OUTPUT_PATH = HS_SCORE_V2_DIR + "_sw_pull_list/gp_sw_pull_{}.csv".format(CURRENT_TS)
